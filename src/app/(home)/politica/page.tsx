    ...
    <div className="bg-background p-6 px-20 maxmd:px-5">
      ...
      <section className="hero text-center pt-20 pb-5 border border-slate-400 drop-shadow-md mb-10">
        <div className="container mx-auto">
          ...
          <p className="mt-4 font-raleway text-sm font-semibold">
      ...
      <div className="bg-background p-10 maxsm:p-5 border border-slate-400 drop-shadow-md ">
        <section className="mb-4">
          ...
          <p className="mt-2 font-raleway text-sm font-semibold">
          ...
          <ul className="list-disc ml-8 mt-2 font-raleway text-sm font-semibold">
            <li>
        ...
        <section className="mb-4">
          ...
          <address className="mt-2 font-raleway text-sm font-semibold ">
